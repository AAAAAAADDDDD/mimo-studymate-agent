...
- Default model: `xiaomi_mimo/mimo-v2-flash`
...
```bash
export XIAOMI_MIMO_API_KEY="your_api_key_here"
```

Windows PowerShell:

```powershell
$env:XIAOMI_MIMO_API_KEY="your_api_key_here"
```
...
1. 在左侧选择学习任务类型
2. 粘贴课程文本、transcript、PPT OCR 文本或案例材料
3. 点击 Generate
4. 查看 Agent 输出的结构化结果与 token 使用记录

## 项目结构

```text
mimo_studymate_agent/
├── app.py
├── requirements.txt
├── README.md
├── .env.example
